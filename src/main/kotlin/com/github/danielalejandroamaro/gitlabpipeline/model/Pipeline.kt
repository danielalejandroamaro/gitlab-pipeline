 ...
 */
/**
 * Asset attached to a release: source archives (auto-generated by GitLab), package links
 * (custom uploads — installers, portables), and evidences (collected at release-cut time).
 * The `kind` drives the UI: only PACKAGE shows a "Descargar" context menu; the rest are
 * double-click-to-browse so the user lands on the GitLab page and grabs what they want.
 */
enum class ReleaseAssetKind { SOURCE, PACKAGE, EVIDENCE, OTHER }

data class ReleaseAsset(
    val name: String,
    val url: String,
    val kind: ReleaseAssetKind,
    /** Direct download URL (when GitLab provides one); falls back to [url] otherwise. */
